...
import EditProfileModal from "../_components/_common/EditProfileModal";
          ...
          <div className="flex items-start justify-center h-full">
            ...
            <div className="flex flex-row h-screen flex-1 gap-0 lg:gap-8">
              <main className="!bg-background lg:max-w-[600px] relative h-full flex-1 flex lg:flex-[0.95]">
                ...
                <hr className="w-[1px] fixed top-0 right-0 lg:right-[calc(100%-71%)] xl:right-[calc(100%-67.6%)] h-screen bg-[#eee] dark:bg-[rgb(47,51,54)]" />
              </main>
